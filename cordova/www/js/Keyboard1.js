...
function setLayout(numberBox,height,value){
    ...
    if(value == 'Cancel' )
    {
        ...
        numberBox.style.backgroundColor = '#ff3b30';
        numberBox.style.color = '#ffffff';
    }

    if(value == 'Confirm' )
    {
        numberBox.style.lineHeight = '75px';
        numberBox.style.backgroundColor = '#64ad37';
        numberBox.style.color = '#ffffff';
    }
    ...
    {
        numberBox.style.lineHeight = '75px';
        numberBox.style.backgroundColor = '#ff6b22';
        numberBox.style.color = '#ffffff';
    }
...
function miniNumberKeyboard () {
    ...
    span.className = 'text-pin-code';
    span.id = 'text-pin-code';
    span.innerHTML = 'Enter your PIN code';
   ...
   // document.body.appendChild(number);
    ...
    /*document.getElementById('Cancel').onclick = function () {
        ...
        keyBoard.removeChild(document.getElementById('text-pin-code'));
}*/
