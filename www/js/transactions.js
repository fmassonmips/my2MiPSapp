        ...
        success: function(data) {
            ...
            jQuery.each(data, function( index, value ) {
                ...
                transactions_status_table += '<tr>'+
                    ...
                    '<br/><button class="col button button-small button-fill color-blue refund-action-button" id="refund_transacation_btn" onclick="refund_transaction(\'' + value.id_commande_format_client  + '\',\'' + value.somme_totale  + '\')">REFUND</button>' +
                    '</td>\n' +
